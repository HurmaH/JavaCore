...
public class MapInterface {
	/*
	 * fundemental difference is data storing key value pair per item
	 */

	public static void main(String[] args) {

		Map<String, Integer> person = new HashMap<>();// HashMap common implementation for Map

		// -------------Map Interface Methods ------------------
		Map<String, Double> priceMap = new HashMap<>();// HashMap common implementation for Map
		...
		System.out.println("priceMap.putIfAbsent(\"Turshi\", 100D) -->" + priceMap.putIfAbsent("Turshi", 100D));

		// V getOrDefault(Object key, V defaultValue)
		System.out.println("My banana price, if not found -->" + priceMap.getOrDefault("Banana", 3.02));
		System.out.println("My sarma price, if not found -->" + priceMap.getOrDefault("Sarma", 5.0));
